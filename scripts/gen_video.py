...
def main():
    parser = argparse.ArgumentParser(description='Generate a video via Seko API.')
    parser.add_argument('--docid', type=str, required=True, help='The plan document ID to generate the video from')
    ...
    try:
        conn.request("POST", "/seko-api/openapi/v1/story-tasks", payload, headers)
